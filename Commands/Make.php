                ...
                "src" => [
                    "Modules" => [
                        $moduleName => [
                            ...
                            "Infrastructure" => [
                                "Migrations" => [
                                    "Install.sql" => "INSERT INTO `modules` (`id`,`module_dependency`,`module_name`,`name`,`description`,`premium`,`count`,`is_website`,`active`) VALUES (NULL,NULL,'$moduleName','$moduleName','$moduleName','0','0','0','1');",
                                    "Uninstall.sql" => "",
                                ],
...
const Sidebar = () => {
  ...
  return (
    <a onClick={(e) => { navigate('/admin') }} data-bs-toggle='tooltip' className='mt-2 cursor-pointer'>
      <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-puzzle' viewBox='0 0 20 20'>
